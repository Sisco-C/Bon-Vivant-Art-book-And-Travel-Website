...
<body>
	<style>
		/*body {
			background-image: url(https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?ixid=MXwxMjA3fDB8MHxzZWFyY2h8MXx8Ym9va3xlbnwwfHwwfA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60);
		}*/
	...
	<br>
		...
		<div class="container-fluid" >
			<h2 style="font-family: verdana; text-align: center; margin-top: 10px; margin-bottom: 10px; " > We Are The Book Haven</h2>
			<hr></div>
			 <nav style="background-color: beige; align-content: center;
    padding: 10px; font-family: verdana; color: black; font-weight: double; font-size: small;" class="navbar navbar-default" id="navbar">

  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand"> BON VIVANT'S BOOK HAVEN</a>
    </div>
		
			<a href="#">MUSTREADS</a>
			<a href="#">BOOK CLUBS</a>	
			<a href="#">BOOK FAIRS AND EVENTS AROUND YOU</a>	
			<a href="#">NETGALLERY</a>	
			<a href="https://www.tumblr.com/blog/view/internetbookhub">BOOK-BLR</a>		
			</div>
			</nav>			
...
<div class="container">
  <div class="row">
    <div class="col-sm-6" style="background-color: purple; color: white;" >
    	<h5>Looking for books to read?</h5>
    ...
    <div class="col-sm-6" style="background-image: url(https://images.unsplash.com/photo-1456315138460-858d1089ddba?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxzZWFyY2h8MTE3fHxib29rc3xlbnwwfHwwfA%3D%3D&auto=format&fit=crop&w=400&q=60); color: white;"> 
    	<h5>What are your friends reading?</h5>
    	<p>
Chances are your friends are discussing their favorite (and least favorite) books on Bon Vivant's book haven</p>
...
<h4 style="text-align: center; font-weight: bolder;" > Book Reviews</h4>
<hr>
<div class="container-fluid">
  <div class="row">
    <div class="col-sm-5">
    	<br>
      <p style="font-weight: bolder; color: black; font-style: italic;"> Purple Hibiscus, Chimamanda Ngozi ~ As Written by Laurette M.</p>
...
<div class="container">
  <div class="row">
   ...
   Nanjala Nyabola, on her debut book, Travelling While Black
    ...
    <div class="col-sm">
    <a href="#"> We get up-close with Janet Mock on her memoir that premiered a week ago. She opens up about her experiences and that led to her writing a book about her various life's misfortunes and the far much greater successes</a>
     <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Janet_Mock_Head_Shot.png/220px-Janet_Mock_Head_Shot.png">
    </div>
  </div>
</div>
<br>
...
<div class="container">
  <div class="row">
    <div class="col-sm">
     <img src="https://images.unsplash.com/photo-1512503959943-9d35a3636b51?ixid=MXwxMjA3fDB8MHxzZWFyY2h8ODZ8fGJvb2tzfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60";>
    </div>
    <div class="col-sm" style="background-color: #342A21; color: white;">
     <input type="text" placeholder="Search book genres">
    ...
    &emsp
    <div class="col-sm" style="color: purple; background-color: #023618">
    	<h4 style="text-align: center;">Book Quotes</h4>
    	<p>
...
<br>
<hr>
<p>“Sometimes, you read a book and it fills you with this weird evangelical zeal, and you become convinced that the shattered world will never be put back together unless and until all living humans read the book.”
...
<br>
<footer>
<div class="jumbotron jumbotron" style="background-color: #020300; color: white;" >
	<div class="container-fluid" style="background-color: #020300; color: white;">
		<div class="row">
  <div class="column">
  	<h4> COMPANY</h4>
		<li><a href="#">
 ...
 &emsp
  <div class="column">
  	<h4> WORK WITH US</h4>
		...
		<li><a href="#">
			Authors Ads and Blogs</a>
		</li>
		<li><a href="mailto:siscoronojey@gmail.com">
			Advertise</a>
		</li>
  </div>
  &emsp
  <div class="column">
  	...
  	<ul><a href="" class="fa fa-tumblr">  Tumblr</a></ul>
  	<ul><a href="" class="fa fa-twitter">  Twitter</a></ul>
  	<ul><a href="" class="fa fa-instagram">  Instagram</a></ul>
  	  </div>
</div>
